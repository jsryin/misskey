...
export * as 'i/check-in' from './endpoints/i/check-in.js';
export * as 'i/check-in/calendar' from './endpoints/i/check-in/calendar.js';
export * as 'i/check-in/status' from './endpoints/i/check-in/status.js';
